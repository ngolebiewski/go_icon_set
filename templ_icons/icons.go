...
func Bluesky(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M2,2h2v1h-2z M11,2h2v1h-2z M1,3h4v1h-4z M10,3h4v1h-4z M1,4h5v1h-5z M9,4h5v1h-5z M1,5h6v1h-6z M8,5h6v1h-6z M1,6h13v1h-13z M2,7h11v1h-11z M3,8h9v1h-9z M5,9h5v1h-5z M3,10h9v1h-9z M2,11h11v1h-11z M2,12h5v1h-5z M8,12h5v1h-5z M3,13h3v1h-3z M10,13h2v1h-2z\" /></svg>", attrs))
		return err
	})
}
...
func Bricks(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M3,0h1v1h-1z M12,0h1v1h-1z M3,1h1v1h-1z M12,1h1v1h-1z M3,2h1v1h-1z M12,2h1v1h-1z M0,3h16v1h-16z M8,4h1v1h-1z M15,4h1v1h-1z M8,5h1v1h-1z M15,5h1v1h-1z M8,6h1v1h-1z M15,6h1v1h-1z M0,7h16v1h-16z M3,8h1v1h-1z M12,8h1v1h-1z M3,9h1v1h-1z M12,9h1v1h-1z M3,10h1v1h-1z M12,10h1v1h-1z M0,11h16v1h-16z M8,12h1v1h-1z M15,12h1v1h-1z M8,13h1v1h-1z M15,13h1v1h-1z M8,14h1v1h-1z M15,14h1v1h-1z M0,15h16v1h-16z\" /></svg>", attrs))
		return err
	})
}
...
func CheckboxChecked(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M4,3h9v1h-9z M3,4h1v1h-1z M12,4h1v1h-1z M3,5h1v1h-1z M12,5h1v1h-1z M3,6h1v1h-1z M10,6h1v1h-1z M12,6h1v1h-1z M3,7h1v1h-1z M9,7h1v1h-1z M12,7h1v1h-1z M3,8h1v1h-1z M8,8h1v1h-1z M12,8h1v1h-1z M3,9h1v1h-1z M5,9h1v1h-1z M7,9h1v1h-1z M12,9h1v1h-1z M3,10h1v1h-1z M6,10h1v1h-1z M12,10h1v1h-1z M3,11h1v1h-1z M12,11h1v1h-1z M3,12h9v1h-9z\" /></svg>", attrs))
		return err
	})
}
...
func CheckboxUnchecked(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M4,3h9v1h-9z M3,4h1v1h-1z M12,4h1v1h-1z M3,5h1v1h-1z M12,5h1v1h-1z M3,6h1v1h-1z M12,6h1v1h-1z M3,7h1v1h-1z M12,7h1v1h-1z M3,8h1v1h-1z M12,8h1v1h-1z M3,9h1v1h-1z M12,9h1v1h-1z M3,10h1v1h-1z M12,10h1v1h-1z M3,11h1v1h-1z M12,11h1v1h-1z M3,12h9v1h-9z\" /></svg>", attrs))
		return err
	})
}
...
func DownTriangle(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M2,5h13v1h-13z M3,6h11v1h-11z M4,7h9v1h-9z M5,8h7v1h-7z M6,9h5v1h-5z M7,10h3v1h-3z M8,11h1v1h-1z\" /></svg>", attrs))
		return err
	})
}
...
func Facebook(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M5,2h5v1h-5z M4,3h7v1h-7z M3,4h4v1h-4z M10,4h2v1h-2z M2,5h4v1h-4z M10,5h3v1h-3z M2,6h4v1h-4z M8,6h5v1h-5z M2,7h4v1h-4z M8,7h5v1h-5z M2,8h3v1h-3z M10,8h3v1h-3z M2,9h3v1h-3z M10,9h3v1h-3z M3,10h3v1h-3z M8,10h4v1h-4z M4,11h2v1h-2z M8,11h3v1h-3z M5,12h1v1h-1z M8,12h2v1h-2z\" /></svg>", attrs))
		return err
	})
}
...
func Hamburger(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M1,2h14v1h-14z M1,3h14v1h-14z M1,7h14v1h-14z M1,8h14v1h-14z M1,12h14v1h-14z M1,13h14v1h-14z\" /></svg>", attrs))
		return err
	})
}
...
func HeartEmpty(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M4,4h2v1h-2z M10,4h2v1h-2z M3,5h1v1h-1z M6,5h1v1h-1z M9,5h1v1h-1z M12,5h1v1h-1z M3,6h1v1h-1z M7,6h2v1h-2z M12,6h1v1h-1z M4,7h1v1h-1z M11,7h1v1h-1z M4,8h1v1h-1z M10,8h2v1h-2z M5,9h1v1h-1z M10,9h1v1h-1z M5,10h2v1h-2z M9,10h2v1h-2z M7,11h2v1h-2z M7,12h2v1h-2z\" /></svg>", attrs))
		return err
	})
}
...
func HeartFilled(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M3,4h2v1h-2z M9,4h2v1h-2z M2,5h4v1h-4z M8,5h4v1h-4z M2,6h10v1h-10z M3,7h8v1h-8z M3,8h8v1h-8z M4,9h6v1h-6z M4,10h6v1h-6z M6,11h2v1h-2z M6,12h2v1h-2z\" /></svg>", attrs))
		return err
	})
}
...
func PencilDiaganol(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M11,3h1v1h-1z M10,4h1v1h-1z M12,4h1v1h-1z M9,5h3v1h-3z M8,6h3v1h-3z M7,7h3v1h-3z M6,8h3v1h-3z M5,9h3v1h-3z M4,10h3v1h-3z M3,11h1v1h-1z M5,11h1v1h-1z M2,12h3v1h-3z M2,13h2v1h-2z M1,14h1v1h-1z\" /></svg>", attrs))
		return err
	})
}
...
func PencilVertical(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M6,0h3v1h-3z M6,1h3v1h-3z M6,3h3v1h-3z M6,4h3v1h-3z M6,5h3v1h-3z M6,6h3v1h-3z M6,7h3v1h-3z M6,8h3v1h-3z M6,9h3v1h-3z M6,10h3v1h-3z M6,11h3v1h-3z M6,12h3v1h-3z M7,13h1v1h-1z M7,14h1v1h-1z\" /></svg>", attrs))
		return err
	})
}
...
func Search(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M9,2h3v1h-3z M8,3h1v1h-1z M12,3h1v1h-1z M7,4h1v1h-1z M13,4h1v1h-1z M7,5h1v1h-1z M13,5h1v1h-1z M7,6h1v1h-1z M13,6h1v1h-1z M8,7h1v1h-1z M12,7h1v1h-1z M7,8h1v1h-1z M9,8h3v1h-3z M6,9h1v1h-1z M5,10h1v1h-1z M4,11h1v1h-1z\" /></svg>", attrs))
		return err
	})
}
...
func Stairs(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M10,5h2v1h-2z M10,6h2v1h-2z M8,7h4v1h-4z M8,8h4v1h-4z M6,9h6v1h-6z M6,10h6v1h-6z M4,11h8v1h-8z M4,12h8v1h-8z\" /></svg>", attrs))
		return err
	})
}
...
func Steam(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M6,0h4v1h-4z M4,1h8v1h-8z M3,2h10v1h-10z M2,3h7v1h-7z M11,3h3v1h-3z M1,4h7v1h-7z M9,4h2v1h-2z M12,4h3v1h-3z M1,5h6v1h-6z M8,5h1v1h-1z M11,5h1v1h-1z M13,5h2v1h-2z M2,6h5v1h-5z M8,6h1v1h-1z M11,6h1v1h-1z M13,6h3v1h-3z M4,7h3v1h-3z M9,7h2v1h-2z M12,7h4v1h-4z M0,8h1v1h-1z M11,8h5v1h-5z M0,9h3v1h-3z M6,9h1v1h-1z M8,9h8v1h-8z M1,10h3v1h-3z M5,10h2v1h-2z M8,10h7v1h-7z M1,11h4v1h-4z M7,11h8v1h-8z M2,12h12v1h-12z M3,13h10v1h-10z M4,14h8v1h-8z M6,15h4v1h-4z\" /></svg>", attrs))
		return err
	})
}
...
func Sword(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M13,1h2v1h-2z M12,2h3v1h-3z M11,3h3v1h-3z M10,4h3v1h-3z M9,5h3v1h-3z M8,6h3v1h-3z M7,7h3v1h-3z M6,8h3v1h-3z M2,9h1v1h-1z M5,9h3v1h-3z M2,10h5v1h-5z M4,11h2v1h-2z M3,12h1v1h-1z M5,12h1v1h-1z M2,13h1v1h-1z M5,13h2v1h-2z M1,14h1v1h-1z\" /></svg>", attrs))
		return err
	})
}
...
func UpTriangle(cfg ...IconConfig) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		attrs := buildStyleAttr(cfg)
		_, err := io.WriteString(w, fmt.Sprintf("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 16 16\" shape-rendering=\"crispEdges\" fill=\"currentColor\" %s><path d=\"M8,5h1v1h-1z M7,6h3v1h-3z M6,7h5v1h-5z M5,8h7v1h-7z M4,9h9v1h-9z M3,10h11v1h-11z M2,11h13v1h-13z\" /></svg>", attrs))
		return err
	})
}
